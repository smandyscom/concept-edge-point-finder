    ...
    public partial class Form1 : Form
    {
        ...
        private void MouseClickHandler(Object sender, MouseEventArgs e)
        {
            ...
            else
            {
                ...
                __control.CreateGraphics().DrawEllipse(__penGreen,
                    __edgeCoordinate.X,
                    __edgeCoordinate.Y,
                    10,
                    10);
                ...
                //point out central point
                __control.CreateGraphics().DrawEllipse(__penBlack,
        ...
        {
            PictureBoxIpl __box = new PictureBoxIpl();
